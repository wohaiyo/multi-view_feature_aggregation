...
def resnet_v1_single_channel(inputs,
              blocks,
              num_classes=None,
              is_training=True,
              global_pool=True,
      ...
      with (slim.arg_scope([slim.batch_norm], is_training=is_training)
        ...
        if include_root_block:
          if output_stride is not None:
            ...
            output_stride /= 4
          net = resnet_utils.conv2d_same(net, 64, 7, stride=2, scope='conv_single_channel')
...
def resnet_v1_50_single_channel(inputs,
                 num_classes=None,
                 is_training=True,
                 global_pool=True,
                 output_stride=None,
  ...
  return resnet_v1_single_channel(inputs, blocks, num_classes, is_training,
