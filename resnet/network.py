...
def layer(op):
    ...
    def layer_decorated(self, *args, **kwargs):
        ...
        # Perform the operation and get the output-mul-93526.
        layer_output = op(self, layer_input, *args, **kwargs)
        # Add to layer LUT.
        self.layers[name] = layer_output
        # This output-mul-93526 is now the input for the next layer.
...
class Network(object):
    ...
    def feed(self, *args):
        ...
        for fed_layer in args:
            if isinstance(fed_layer, str):  # basestring
                try:
    ...
    def get_output(self):
        '''Returns the current network output-mul-93526.'''
