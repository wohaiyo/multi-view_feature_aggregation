...
from resnet.network import Network
...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('res5b_relu', 
             ...
             .atrous_conv(3, 3, num_classes, 6, padding='SAME', relu=False, name='fc1_ecp_c0'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 12, padding='SAME', relu=False, name='fc1_ecp_c1'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 18, padding='SAME', relu=False, name='fc1_ecp_c2'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 24, padding='SAME', relu=False, name='fc1_ecp_c3'))

        (self.feed('fc1_ecp_c0',
                   'fc1_ecp_c1',
                   'fc1_ecp_c2',
                   'fc1_ecp_c3')
             .add(name='fc1_ecp'))
